# Focus on tau-27 to filter Q density

"""
Parallel version: use parallel calculation in each necessary step (this version is much faster)

Q density filter: nonnegative -> smooth -> unimodal (one peak)
"""
